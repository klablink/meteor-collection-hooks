...
declare module 'meteor/mongo' {
  ...
  module Mongo {
    ...
    type THookThisWithTransformAndPrevious<T, UnderlyingMethod extends GenericFunction> =
      THookThisWithTransform<T, UnderlyingMethod>
      & {
      previous: T
    }
    ...
    type THookBeforeUpdate<T, O = void> = (this: THookThis<T, Collection<T>['update']> & {
      previous: T,
      transform: (doc: T) => T
    }, userId: string | undefined, doc: T, fieldNames: string[], modifier: any, options: any) => O
    type THookAfterUpdate<T, O = void> = (this: THookThisWithTransformAndPrevious<T, Collection<T>['update']> & {
      previous: T,
      transform: (doc: T) => T
    }, userId: string | undefined, doc: T, fieldNames: string[], modifier: any, options: any) => O
